...
/**
 * Sentinel View class for the Set
 */
class SentinelViewSet extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$HeaderCheck = new sentinelHeaderCheck;
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_sentinel/assets/css/set.css', (SentinelHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SentinelHelper::getHelpUrl('set');
	...
	public function escape($var, $sorten = false, $length = 40)
	{
		...
		return SentinelHelper::htmlEscape($var, $this->_charset, $sorten, $length);
	}
}
