...
abstract class SentinelHelper
{
	...
	**/
	public static function addSubmenu($submenu)
	{
		...
		if ($user->authorise('form.access', 'com_sentinel') && $user->authorise('form.submenu', 'com_sentinel'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_SENTINEL_SUBMENU_FORMS'), 'index.php?option=com_sentinel&view=forms', $submenu === 'forms');
		}
		if ($user->authorise('data_set.access', 'com_sentinel') && $user->authorise('data_set.submenu', 'com_sentinel'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_SENTINEL_SUBMENU_DATA_SETS'), 'index.php?option=com_sentinel&view=data_sets', $submenu === 'data_sets');
		}
		if ($user->authorise('type.access', 'com_sentinel') && $user->authorise('type.submenu', 'com_sentinel'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_SENTINEL_SUBMENU_TYPES'), 'index.php?option=com_sentinel&view=types', $submenu === 'types');
		}
	}
	...
	**/
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Sentinel', $config = array())
	{
		// fix the name
