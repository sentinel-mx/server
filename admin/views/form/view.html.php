...
class SentinelViewForm extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_sentinel/assets/css/form.css", (SentinelHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		// Add Ajax Token
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_sentinel/views/form/submitbutton.js", (SentinelHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
