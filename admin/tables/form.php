 ...
 * Forms Table class
 */
class SentinelTableForm extends JTable
{
	/**
	...
	{
		parent::__construct('#__sentinel_form', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_sentinel.form'));
	}	
	...
	/**
	 * Overload the store method for the Form table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SENTINEL_FORM_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_sentinel.form.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_sentinel.form.'.(int) $this->$k;
	}
